...
namespace OccaSoftware.Altos.Editor
{
    ...
    public class SkyboxDefinitionEditor : UnityEditor.Editor
    {
        ...
        SerializedProperty cloudinessExposureFactor;
        ...
        private void OnEnable()
        {
            ...
            cloudinessExposureFactor = serializedObject.FindProperty("cloudinessExposureFactor");
        ...
        void DrawEnvironmentLightingSettings()
        {
            ...
            if (showEnvironmentLighting)
            {
                ...
                EditorGUILayout.Slider(cloudinessExposureFactor, 0f, 1f, new GUIContent("Cloudiness Exposure Factor", "A lower value is a lower exposure decrease as cloudiness increases, and a higher value is a higher exposure decrease as cloudiness increases.")); 
